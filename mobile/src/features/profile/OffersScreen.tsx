          ...
          {coupons.map((coupon, idx) => (
            <Card key={idx} style={{ padding: 16 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                <View style={{ backgroundColor: 'rgba(201, 107, 60, 0.08)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10, borderWidth: 1, borderStyle: 'dashed', borderColor: theme.colors.secondary }}>
